...
export const KANTO_LOCATIONS: Array<{ key: string; info: KantoLocationInfo }> = [
  ...
  { key: 'Mt. Moon',         info: { slug: 'mtmoon',         mapNum: 41,  label: 'Mt. Moon',         region: 'kanto' } },
  { key: 'Rock Tunnel',      info: { slug: 'rocktunnel',     mapNum: 42,  label: 'Rock Tunnel',      region: 'kanto' } },
  { key: 'Pokémon Tower',    info: { slug: 'pokemontower',   mapNum: 43,  label: 'Pokémon Tower',    region: 'kanto' } },
  { key: 'Pokemon Tower',    info: { slug: 'pokemontower',   mapNum: 43,  label: 'Pokémon Tower',    region: 'kanto' } },
  { key: 'Safari Zone',      info: { slug: 'safarizone',     mapNum: 44,  label: 'Safari Zone',      region: 'kanto' } },
  { key: 'Seafoam Islands',  info: { slug: 'seafoamislands', mapNum: 45,  label: 'Seafoam Islands',  region: 'kanto' } },
  { key: 'Victory Road',     info: { slug: 'victoryroad',    mapNum: 46,  label: 'Victory Road',     region: 'kanto' } },
  { key: "Diglett's Cave",   info: { slug: 'diglettscave',   mapNum: 47,  label: "Diglett's Cave",   region: 'kanto' } },
  { key: 'Digletts Cave',    info: { slug: 'diglettscave',   mapNum: 47,  label: "Diglett's Cave",   region: 'kanto' } },
  { key: 'Power Plant',      info: { slug: 'powerplant',     mapNum: 48,  label: 'Power Plant',      region: 'kanto' } },
  { key: 'Cerulean Cave',    info: { slug: 'ceruleancave',   mapNum: 49,  label: 'Cerulean Cave',    region: 'kanto' } },
  { key: 'Pokémon Mansion',  info: { slug: 'pokemonmansion', mapNum: 50,  label: 'Pokémon Mansion',  region: 'kanto' } },
  { key: 'Pokemon Mansion',  info: { slug: 'pokemonmansion', mapNum: 50,  label: 'Pokémon Mansion',  region: 'kanto' } },
  { key: 'Rocket Hideout',   info: { slug: 'rockethideout',  mapNum: 51,  label: 'Rocket Hideout',   region: 'kanto' } },
  { key: 'Silph Co.',        info: { slug: 'silphco',        mapNum: 52,  label: 'Silph Co.',        region: 'kanto' } },
  { key: 'SS Anne',          info: { slug: 'ssanne',         mapNum: 53,  label: 'SS Anne',          region: 'kanto' } },
];
